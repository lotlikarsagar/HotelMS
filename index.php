...
<hr>
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@IMPERIAL.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9832217712</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">IMPERIAL<p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
						...
						<div class="w3layouts-banner-top w3layouts-banner-top1">
							<div class="container">
								...
								<h4>IMPERIAL HOTEL</h4>
									<h3>Enjoy pleasant moments with friends & families</h3>
										<p>Have a memorable experience</p>
									<div class="agileits_w3layouts_more menu__item">
				<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">Learn More</a>
			</div>
								</div>	
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">IMPERIAL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
					...
					<ul class="slides">
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>BEST AND MEMORBLE EXPERIENCES. </p>
								<h5>Manish gaikwad</h5>
								<p>INDIA</p>
							</div>
							<div class="clearfix"> </div>
						</li>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 9872361266</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@IMPERIAL.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> NEAR ANJUNA BEACH ,GOA,INDIA</p>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7686.648179066402!2d73.7349528904558!3d15.574323840142812!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbfe98f11ab0199%3A0xd777cc02c2ccffa1!2sAnjuna%20Beach!5e0!3m2!1sen!2sin!4v1685984345581!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2023 . All Rights Reserved | Design by <a href="index.php"> TEAM IMPERIAL</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
